const MONSTERS = {
  ram: {
    ...
    hp: 32175, atk: 1198, def: 100, stagger: 60, staggerRecovery: 6, range: 2.1, weight: 1,
  ...
  falsewings: {
    ...
    hp: 25740, atk: 958, def: 100, stagger: 60, staggerRecovery: 6, range: 6, weight: 1,
    resist: { physical: 1, heat: 1, electric: 1, cryo: 1, nature: 1, ether: 1 },
  ...
  heavyRam: {
    ...
    hp: 193052.6, atk: 2395, def: 100, stagger: 160, staggerRecovery: 7, range: 3.2, weight: 1.5,
  ...
  heavyRamAlpha: {
    ...
    hp: 289578.9, atk: 2635, def: 100, stagger: 200, staggerRecovery: 7.5, range: 3.2, weight: 1.5,
    resist: { physical: .8, heat: .8, electric: 1, cryo: 1, nature: .8, ether: 1 },
  ...
  heavySting: {
    ...
    hp: 170530.1, atk: 1796, def: 100, stagger: 140, staggerRecovery: 7, range: 7, weight: 1.5,
    resist: { physical: .8, heat: .8, electric: 1, cryo: 1, nature: .8, ether: 1 },
  ...
  heavyStingAlpha: {
    ...
    hp: 254186.4, atk: 2156, def: 100, stagger: 180, staggerRecovery: 7.5, range: 7, weight: 1.5,
    resist: { physical: .8, heat: .8, electric: 1, cryo: 1, nature: .8, ether: 1 },
  ...
  effigy: {
    ...
    hp: 289578.9, atk: 2395, def: 100, stagger: 340, staggerRecovery: 9, range: 12, weight: 2,
    resist: { physical: .8, heat: .8, electric: 1, cryo: 1, nature: .8, ether: 1 },
  ...
  mudflow: {
    ...
    hp: 41827.5, atk: 958, def: 100, stagger: 60, staggerRecovery: 6, range: 2.1, weight: 1,
  ...
  hedron: {
    ...
    hp: 35392.5, atk: 958, def: 100, stagger: 60, staggerRecovery: 6, range: 2.1, weight: 1,
    resist: { physical: 1, heat: 1, electric: .8, cryo: .8, nature: 1, ether: 1 },
  ...
  prism: {
    ...
    hp: 25740, atk: 958, def: 100, stagger: 60, staggerRecovery: 6, range: 2.1, weight: 1,
    resist: { physical: 1, heat: 1, electric: .8, cryo: .8, nature: 1, ether: 1 },
  ...
  tidewalker: {
    ...
    hp: 289578.9, atk: 2395, def: 100, stagger: 320, staggerRecovery: 9, range: 2.8, weight: 1.2,
    resist: { physical: 1, heat: 1, electric: .8, cryo: .8, nature: 1, ether: 1 },
  ...
  tidalklast: {
    ...
    hp: 321755.2, atk: 2395, def: 100, stagger: 640, staggerRecovery: 13, range: 2.8, weight: 1.5,
    resist: { physical: 1, heat: 1, electric: .8, cryo: .8, nature: 1, ether: 1 },
